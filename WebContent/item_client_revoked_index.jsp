...
<script type="text/javascript">
 ...
 function revoked_item(){
	    ...
	    document.form1.action="fbrevokedclient.vs";
	 	     ...
	 	     <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="btn-group" style="float: right;margin-right: 30px;">
			            <button onclick="revoked_item()"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00777' /></button>
			      </div>

...
/*发送节目*/
 function send_item(){
	    ...
	    document.form1.action="totreasureclientrevoked.vs";
	   // document.form1.action="totreasurecliebtFb.vs?tIdStr="+$("#tids").val()+"&clientids="+clientids;
	...
	<div class="c_right"  style="height: 550px;">
	 	     ...
	 	     <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-3" style="margin-left: -28px;" >
				     	<button  onclick="selsc('tofbtreasure.vs')" class="btn btn-sm btn-primary" type="button" style="padding: 4px 8px;"><i class="icon icon-search"></i></button>
				  </div> 
				  
				  <div class="btn-group" style="margin-left:670px;margin-top:-24px;">
				      
				    
					       <button onclick="send_item()"  type="button" class="btn btn-sm btn-primary">撤销</button>
		...
		<div id="showsonlist"> 
				...
				<div class="nav">
					<ul class="pg">
		                <!-- 上一页-->
						<li><a href="javascript:pageto(<ww:property value='qian' />,'tofbtreasure.vs');" class="pg_f"></a></li>
			            <!--页码显示上-->
						<ww:iterator id="q"  value="ps.qs">
			                  <li><a href="javascript:pageto(<ww:property value='#q'/>,'tofbtreasure.vs');" ><ww:property value="#q"  /></a> </li>
			            </ww:iterator>
			            
			            <!--当前页码-->
			            <li><a href="javascript:pageto(<ww:property value='#request.id'  />,'tofbtreasure.vs');" style="background-color:#FFA534;"><ww:property value="#request.id"  /></a> </li>
			            
			             <!--页码显示下-->
			            <ww:iterator id="h"  value="ps.hs">
			                  <li><a href="javascript:pageto(<ww:property value='#h'/>,'tofbtreasure.vs')"><ww:property value="#h"  /></a></li>
			            </ww:iterator>
			            
		                <!--下一页-->
			            <li><a href="javascript:pageto(<ww:property value='hou' />,'tofbtreasure.vs');" class="pg_e"></a></li>
					</ul>
					...
					<div class="pg_count">
					     ...
					     <a href="javascript:setpagetype(10,'tofbtreasure.vs');" <ww:if test='pagetype==10'>style="background-color:#FFA534;"</ww:if> >10</a>
					     <a href="javascript:setpagetype(20,'tofbtreasure.vs');" <ww:if test='pagetype==20'>style="background-color:#FFA534;"</ww:if> >20</a>
					     <a href="javascript:setpagetype(30,'tofbtreasure.vs');" <ww:if test='pagetype==30'>style="background-color:#FFA534;"</ww:if> >30</a>
					     <a href="javascript:setpagetype(<ww:property value='total'/>,'tofbtreasure.vs');" <ww:if test='pagetype==total'>style="background-color:#FFA534;"</ww:if> ><ww:property value='#session.local.a00815' /></a>
					</div>
					<!--隐藏域 -->
...
<input type="hidden" value="<ww:property value='tids'/>" name="tids" id="tids"/>          <!-- 节目ids -->  

...
function addcg(){
	...
	var igname =document.getElementById("itemgname").value;
	if (igname.length < 1) {
	...
	$.ajax({
	 	 url:'ajaxinteractitemaddcheck.vs',
		 data:{
			tid : tid.value,
			igname : igname
		 },
	     ...
	     success:function(data) {
		     if(data == '0'){
			    if(igname == "<ww:property value='#session.local.a00148' />" || igname == "<ww:property value='#session.local.a00850' />"){
			    	layer.msg("<ww:property value='#session.local.a00989' />!");
				}else{
					document.form1.target = "_self";
		    		document.form1.action = 'addiitg.vs'; 
	                    ...
	                    <table class="insert-tab" width="100%">
	                        <tbody>
		                        <tr>
		                            ...
		                            <td>
		                                   <input  class="common-text required" id="itemgname" name="itemgname"    type="text"/>
		                            </td>
		                        </tr>
	                            <tr>
	                                <th></th>

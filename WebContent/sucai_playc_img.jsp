...
function outplaycImg(){
    ...
    layer.open({
        ...
        content: 'outplaycImg.vs?sel='+sel+"&ser="+ser+"&stype="+stype+"&datemode="+datemode+"&btime="+btime+"&etime="+etime,
        scrollbar: false,
        end: function(){ 
...
<!--				</li>-->
				<li>
					<button  onclick="selscpc('4')" class="btn btn-sm btn-primary" style="width:80px;" type="button"><ww:property value='#session.local.a00061' /></button>
				</li>
				<li>

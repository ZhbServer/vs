   ...
   <form  name="form1" method="post" >
      <div style=" margin: 10px 0px 0px 10px;">
        <ul class="nav nav-tabs">
		  ...
		  <li class="active"><a href="seeinteractiteminfo.vs?itemId=<ww:property value='itemId'/>&itemType=2"><ww:property value="#session.local.b00185" /></a></li><!-- 节目属性 -->
		  
		  <li><a href="itemEditHistory.vs?itemId=<ww:property value='itemId'/>&itemType=2"><ww:property value="#session.local.b00186" /></a></li><!-- 修改历史 -->

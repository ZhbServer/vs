 ...
 function send_time_send(){
		...
		//}else if(fbtype==2){
            ...
            if(comptime(sdate,edate)){
           	     ...
           	     document.form1.action = "sendtimeitem.vs"; 
...
<div class="title bottom">
		<div class="t_container">
			...
			<div class="material_show" style="font-size: 14px;color:#343F51;height: 30px;line-height: 30px; ">
			   <!-- 播放周期 -->
			   <ww:property value="#session.local.a00575" /> 
			    <select name="day" id="day"  style="width: 60px;height: 23px;">
				  	<option value="8"><ww:property value='#session.local.a00483' /></option>   <!-- 每天 -->
			        <option value="1"><ww:property value='#session.local.a00475' /></option>   <!-- 周一 -->
			        <option value="2"><ww:property value='#session.local.a00476' /></option>   <!-- 周二 -->
			        <option value="3"><ww:property value='#session.local.a00478' /></option>   <!-- 周三 -->
			        <option value="4"><ww:property value='#session.local.a00479' /></option>   <!-- 周四 -->
			        <option value="5"><ww:property value='#session.local.a00480' /></option>   <!-- 周五 -->
			        <option value="6"><ww:property value='#session.local.a00481' /></option>   <!-- 周六 -->
			        <option value="7"><ww:property value='#session.local.a00482' /></option>   <!-- 周日 -->
			    </select>
			   <!--开始时间-->
			   <ww:property value="#session.local.a00540"/>:
			   <input type="text"  name="sdate" id="sdate"  value="08:30:00"  size="6" maxlength="8"  style="height: 23px;width: 100px;" />
			   <!-- 结束时间 -->
			   <ww:property value="#session.local.a00541"/>:
			   <input type="text" name="edate" id="edate"  value="22:30:00"  size="6" maxlength="8"  style="height: 23px;width: 100px;" /> 
			   <input class="button_type1" onclick="send_time_send()"  type="button" value="<ww:property value='#session.local.a00421' />"/>

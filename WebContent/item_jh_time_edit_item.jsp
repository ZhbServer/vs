         ...
         if(gosubmit()){
             ...
             var day = $("#day").val();
              $.ajax({
				type:'post',
				url:'editjhitem.vs',
				data:"jhid="+jhid+"&jhitemid="+jhitemid+"&filenames="+filenames+"&itemnames="+itemnames+"&validitySdate="+validitySdate+"&validityEdate="+validityEdate+"&day="+day,
				dataType:'json',
				async:true,
				cache:true,
				success:function(data){
...
<body onload="onload_data()" style="height: 100%;">

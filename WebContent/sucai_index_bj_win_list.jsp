		   ...
		   <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				     	<button class="btn btn-sm btn-primary" onclick="replace_sucai_list('tosclist.vs?sucai.type=1&pagetype=10&showtype=1')" type="button"><ww:property value='#session.local.a00069' /></button>
				     	<ww:if test="isSelf!=0">
				  ...
				  <input type="checkbox"  style="display: none;" id="all" />
				   <ww:if test="isSelf!=0">
					   <div class="btn-group" style="float: right;margin-right: 30px;">
						  ...
						  <button onclick="openUpload('upbj.jsp',1)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00063' /></button>

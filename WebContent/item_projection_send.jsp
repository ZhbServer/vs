...
<script type="text/javascript">
  ...
  function jh_send(){
	  ...
	  document.form1.action="projectionsend.vs";
...
<div class="title bottom">
		<div class="t_container">
			<div class="loc">
			        ...
			        <span class="function"><ww:property value='#session.local.b00278' /></span>
...
<input type="hidden" value="<ww:property value='proId'/>" name="proId"  id="proId" />                    <!-- 台标ID -->

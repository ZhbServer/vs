	...
	function init_self(){
		...
		if(openIntro == '1'){
			...
			steps: [
			    {
				    element: '#step1',
				    intro: "<ww:property value='#session.local.a00947' />",
				    position: "top"
				},  	
				{  
					element: '#step2',  
					intro: "<ww:property value='#session.local.a00874' /><span style='color:blue'> <ww:property value='#session.local.a00063' /></span><ww:property value='#session.local.a00887' />"
				}
			  ]  
			});  
			...
			steps: [
				{
					element: '#step4',
					intro: "<ww:property value='#session.local.a00948' />"
				}
			  ]  
			});  
	   ...
	   layer.open({
	        ...
	        scrollbar: false,
			   ...
			   if(window.returnValue=="close"){
				   document.form1.action = "tosclist.vs?sucai.type=1&gssi.sucaigroupid=0";
			   }else{
				   document.form1.action = "tosclist.vs?sucai.type=1&gssi.sucaigroupid=0&openIntro=2";
			   }
			...
			<div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				     	<button class="btn btn-sm btn-primary" onclick="replace_sucai_list('tosclist.vs?sucai.type=1&pagetype=12&showtype=2')" type="button"><ww:property value='#session.local.a00070' /></button>
				     	<ww:if test="isSelf!=0">
				  		     <button onclick="add_share('addshare.vs',1)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00816' /></button>
				  		</ww:if>
				  </div> 
				  <ww:if test="isSelf!=0">

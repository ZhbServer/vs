...
<div class="c_middle">
	...
	<div class="c_right" >
		      ...
		      <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				     	<button class="btn btn-sm btn-primary" onclick="replace_sucai_list('tosclist.vs?sucai.type=9&pagetype=12&showtype=2')" type="button"><ww:property value='#session.local.a00070' /></button>
				     	<ww:if test="isSelf!=0">
		...
		<div class="nav">
			<ul class="pg">
                <!-- 上一页-->
				<li><a href="javascript:tosclistajax_sc(<ww:property value='qian' />,'tosclist.vs');" class="pg_f"></a></li>
	            <!--页码显示上-->

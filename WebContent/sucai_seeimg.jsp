		                 ...
		                 <table class="insert-tab" width="100%">
	                        <tbody>
	                         <tr>
	                         	<th width="200"></th>
	                         	<td>
	                         		<img onClick="bigImg('<ww:property value="fname" />')" src='files/<ww:property value="fname" />' width='<ww:property value='seewidth' />px' height='<ww:property value='seeheight' />px' />
	                         	</td>
	                         </tr>
	                         <tr>
	                            <!-- 素材名 -->

...
<html>
  <head>
   ...
   //按钮(点击选择音频)
   var upbutton="<ww:property value='#session.local.a00811'  />";
   ...
   //显示(首音频)
   var a00790="<ww:property value='#session.local.a00792'  />";
   ...
   //显示(首)
   var a00800="<ww:property value='#session.local.a00802'  />";
 ...
 //资源存储空间不足,请联系管理员
   ...
   //上传地址
   var upserver="upaudio.vs";
   //上传格式
   var upextensions="mp3,wma,wav";

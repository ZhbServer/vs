		     ...
		     <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				     	<button class="btn btn-sm btn-primary" onclick="replace_sucai_list('tosclist.vs?sucai.type=4&pagetype=12&showtype=2')" type="button"><ww:property value='#session.local.a00070' /></button>
				     	<ww:if test="isSelf!=0">

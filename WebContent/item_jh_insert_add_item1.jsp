    ...
    function savaSubmit(){
         if(gosubmit()){
             ...
             $.ajax({
   				type:'post',
   				url:'adjhitem1.vs',
   				data:"jhid="+jhid+"&filenames="+filenames+"&itemnames="+itemnames+"&validitySdate="+validitySdate+"&validityEdate="+validityEdate+"&validityXdate="+validityXdate,
   				dataType:'json',
   				async:true,
   				cache:true,
   				success:function(data){
   					if(data == "0"){
   						...
   						layer.msg("<ww:property value='#session.local.a00124' />");
    ...
    <form method="post" name="form1" action="">
       <div class="panel panel-primary" style="margin: 3px 3px;">
           <div class="panel-heading">
                <ww:property value="#session.local.a00490"/> <!-- 添加计划 -->
           </div>
        ...
        <div style="width:850px;height:40px;margin:10px auto">
			<!-- 下载时间 

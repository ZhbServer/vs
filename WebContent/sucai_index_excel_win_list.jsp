...
<div class="title bottom">
	<div class="t_container">
			<div class="loc">
			       <ww:property value='#session.local.a00065' /> :<span class="function"><ww:property value='#session.local.a00007' /></span><span class="material_bg">Excel</span>
			</div>
	       ...
	       <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				     	<button class="btn btn-sm btn-primary" onclick="replace_sucai_list('tosclist.vs?sucai.type=8&pagetype=10&showtype=1')" type="button"><ww:property value='#session.local.a00069' /></button>
				  		<ww:if test="isSelf!=0">
				  		   <button onclick="add_share('addshare.vs',8)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00816' /></button>
				  		</ww:if>
				  </div> 
				   ...
				   <ww:if test="isSelf!=0">
					   <div class="btn-group" style="float: right;margin-right: 30px;">
						  ...
						  <button onclick="openUpload('upexcel.jsp',8)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00063' /></button>
        ...
        <div class="con" id="con" style="overflow: auto;height: 410px;"  >
    	   <ul class="display_container" style="padding-left: 0px;">
    	    ...
    	    <ww:iterator value="listsc" status="status">
    	         ...
    	         <li   ondblclick="yulan('seepics.vs?scid=<ww:property value='id' />')"

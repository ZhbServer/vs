...
<script type="text/javascript">
	...
	function openadnotice(){
		layer.open({
	         ...
	         content: 'toaddnotice.vs',
	         scrollbar: false,
	         end: function(){
	         
				document.form1.target = "_self";
				document.form1.action = "tonoticejhlist.vs"; 
    ...
    function updatenotice(id){
	    ...
	    layer.open({
	         ...
	         fix: false, //不固定
	         shift: Math.ceil(Math.random()*6), //0-6的动画形式，-1不开启
	         content: 'toupdnotice.vs?nid='+nid,
	         scrollbar: false,
	         end: function(){ 
		    	document.form1.target = "_self";
				document.form1.action = "tonoticejhlist.vs"; 
    ...
    function deletenotice(id){
	   	layer.confirm("<ww:property value='#session.local.a00092' />?", {icon: 3, title:"<ww:property value='#session.local.a00093' />",btn: ["<ww:property value='#session.local.a00080' />", "<ww:property value='#session.local.a00014' />"]}, function(index,layero){
	   		document.getElementById("nid").value=id;
	        document.form1.action="delnotice.vs";
	        document.form1.submit();
	    });
    }
	...
	<div class="c_right_header" style="height: 35px;">
		<div class="row">
		   <div class="btn-group" style="float: right;margin-right: 50px;">
			  ...
			  <button onclick="openadnotice()" type="button" class="btn btn-sm btn-success" style="margin-left:10px;"><ww:property value='#session.local.a00826' /></button><!-- 新增-->
	       </div>				  
		 </div>
	</div>
          ...
          <div style="padding-right:17px;margin: 0px;">
	            <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 0px;">
	              <tr class="cell_element cell_first">
					...
					<td style="width:20%" align="center"><ww:property value='#session.local.a00540' /></td>
					<td style="width:20%" align="center"><ww:property value='#session.local.a00541' /></td>
				...
				<table border="0" cellpadding="0" cellspacing="0" style="margin-top: 0px; margin-bottom: 0px;">
					<ww:iterator value="notices">
						<tr class="cell_element cell_show">
						  ...
						  <td style="width:30%" align="center"><ww:property value="fonttitle" /></td>
						  <td style="width:20%" align="center"><ww:property value="sdate" /></td>
						  <td style="width:20%" align="center"><ww:property value="edate" /></td>
		...
		<div class="nav" style="width: 1000px;margin-left:20px;">
			<ul class="pg">
                <!-- 上一页-->
				<li><a href="javascript:pageto(<ww:property value='qian' />,'tonoticejhlist.vs');" class="pg_f"></a></li>
	            <!--页码显示上-->
				<ww:iterator id="q"  value="ps.qs">
	                  <li><a href="javascript:pageto(<ww:property value='#q'/>,'tonoticejhlist.vs');" ><ww:property value="#q"  /></a> </li>
	            </ww:iterator>
	            
	            <!--当前页码-->
	            <li><a href="javascript:pageto(<ww:property value='#request.id'  />,'tonoticejhlist.vs');" style="background-color:#FFA534;"><ww:property value="#request.id"  /></a> </li>
	            
	             <!--页码显示下-->
	            <ww:iterator id="h"  value="ps.hs">
	                  <li><a href="javascript:pageto(<ww:property value='#h'/>,'tonoticejhlist.vs')"><ww:property value="#h"  /></a></li>
	            </ww:iterator>
	            
                <!--下一页-->
	            <li><a href="javascript:pageto(<ww:property value='hou' />,'tonoticejhlist.vs');" class="pg_e"></a></li>
			</ul>
			...
			<div class="pg_count">
			     ...
			     <a href="javascript:setpagetype(10,'tonoticejhlist.vs');" <ww:if test='#session.publicPagetype==10'>style="background-color:#FFA534;"</ww:if>  >10</a>
			     <a href="javascript:setpagetype(20,'tonoticejhlist.vs');" <ww:if test='#session.publicPagetype==20'>style="background-color:#FFA534;"</ww:if> >20</a>
			     <a href="javascript:setpagetype(30,'tonoticejhlist.vs');" <ww:if test='#session.publicPagetype==30'>style="background-color:#FFA534;"</ww:if> >30</a>
			     <a href="javascript:setpagetype(-1,'tonoticejhlist.vs');" <ww:if test='#session.publicPagetype==-1'>style="background-color:#FFA534;"</ww:if> ><ww:property value='#session.local.a00815' /></a>
			</div>

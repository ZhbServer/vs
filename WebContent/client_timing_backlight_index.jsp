...
var intro;
  ...
  function plan_add(){
	  layer.open({
	         ...
	         fix: false, //不固定
	         shift: Math.ceil(Math.random()*6), //0-6的动画形式，-1不开启
	         content: 'client_timing_backlight_add.jsp',
	         scrollbar: false,
	         end: function(){
				  if(window.returnValue==undefined||window.returnValue==""){
					   window.returnValue=""; 
						...
						document.form1.action = "totimingBacklight.vs"; 
						document.form1.submit(); 
				  }    
	 		 }
	 	});   
  ...
  function plan_onoff_send(){
	  var task=document.getElementById("task").value;
 	  ...
 	  document.form1.action="fbTimingBacklight.vs";
      document.form1.submit();
  }
  ...
  function onoff_del(theone){
		...
		document.form1.action = "timingBacklightdel.vs"; 
		document.form1.submit(); 
  ...
  function onoff_edit(theone){
	  ...
	  layer.open({
	         ...
	         fix: false, //不固定
	         shift: Math.ceil(Math.random()*6), //0-6的动画形式，-1不开启
	         content: 'totimingBacklightEdit.vs?selonoff='+theone,
	         scrollbar: false,
	         end: function(){
				  if(window.returnValue==undefined||window.returnValue==""){
					   window.returnValue=""; 
		 ...
		 <div class="title bottom">
				<div class="t_container">
				    <div class="loc">
					        ...
					        <span class="function"><ww:property value='#session.local.a00156' /></span>
					        <span class="material_bg"><ww:property value='#session.local.b00325' /></span>
					</div>
		                  ...
		                  <div style="padding-right:17px;margin-top: -5px;">
		                        <table border="0" cellpadding="0" cellspacing="0">
								      <tr class="cell_element cell_first">
										  ...
										  <td style="width:30%" align="center"><ww:property value='#session.local.b00325' /></td>

  ...
  var currentdiv;
    ...
    $(function(){
	 ...
	 $("input:radio[name='upType']").click(function(){
	  ...
	  //初始化数据 
	  var mType="<ww:property value='editTB.mType' />";
	  if(mType==1){
		  $("input:radio[name='mType']").eq(1).attr("checked",'checked');
		  $("#trUpType").show();
          　 
          var mTimeout="<ww:property value='editTB.mTimeout' />";

		  if(mTimeout==-1){
			  
			  $("input:radio[name='upType']").eq(1).attr("checked",'checked');
		  }else{
			  $("input:radio[name='upType']").eq(0).attr("checked",'checked');
			  $("#trUpTime").show();

			  $("#mTimeout").val(mTimeout);
		  }
		  

	  }else{
		  
		  $("input:radio[name='mType']").eq(0).attr("checked",'checked');
...
<body>
   ...
   <form  name="form1" method="post" >
       <input name="tbId" type="hidden" value="<ww:property value='editTB.id'/>"/>
		                    ...
		                    <table class="insert-tab" width="100%">
		                        <tbody>
		                         ...
		                         <tr>
		                            ...
		                            <td>
		                               <input  name="title" id="title" id="title" value="<ww:property value='editTB.title'/>"  type="text"/>
		                            </td>
		                          </tr>
		                         <tr>
		                         ...
		                         <tr>
		                            ...
		                            <td>
		                                ...
		                                <!-- left -->
		                                left:  
		                                <input type="text" id="l" name="l"  value="<ww:property value='editTB.l'/>" style="width: 80px;"/>
		                                
		                                <!-- top -->
		                                top:
		                                <input type="text" id="t" name="t" value="<ww:property value='editTB.t'/>" style="width: 80px;"/>
		                                
		                                <!-- width -->
		                                <ww:property value="#session.local.a00032"/>
		                                <input type="text" id="w" name="w" value="<ww:property value='editTB.w'/>" style="width: 80px;"/>
		                                
		                                <!-- height -->
		                                <ww:property value="#session.local.a00033"/>
		                                <input type="text" id="h" name="h" value="<ww:property value='editTB.h'/>"  style="width: 80px;"/>
		                         ...
		                         <tr>
		                           ...
		                           <tr>
		                            ...
		                            <td>
		                               <input type="text" name="mUrlName" id="mUrlName"  value="<ww:property value='editTB.mUrlName'/>" />
		                               <input  type="hidden" name="mUrl" id="mUrl" value="<ww:property value='editTB.mUrl'/>"/>

...
<script type="text/javascript">
    ...
    var conditionalOnOff="<ww:property value='#session.version_onoff.conditionalOnOff' />";

    var b00356="<ww:property value='#session.local.b00356' />";
		  ...
		  <div class="pm_mid" style="margin: 0% 0% 0% 0%">
		       ...
		       <!--制作区下方菜单-->
		        <div class="pm_mid_footer" style="margin-left:2%;margin-top: 0px;">
                    ...
                    <!-- 智能播放 -->
					<div style="float: left;margin-top: 0px;margin-left:-5px;" title="<ww:property value='#session.local.b00194' />">  
					...
					<ww:if test="#session.version_onoff.conditionalOnOff==1">
					  <!-- key -->
					  <div style="float: left;margin-top:0px;">
					     key : <input type="text" id="itemKey" name="itemKey"  value="<ww:property value='itemKey' />" style="width:60px;color:#626262;"/>
					  </div>
					</ww:if>
					...
					<!-- 保存 -->
					<button id="step5"   style="margin-top:-5px;" class="btn  btn-primary" onclick="check_save_item()" type="button"><ww:property value='#session.local.a00254' /></button>
					
					
					<ww:if test="itemViceType==1">
					
					<!-- 副屏节目 -->
					<button    style="margin-top:-5px;" class="btn  btn-warning" onclick="open_sub_screen(1)" type="button"><ww:property value='#session.local.b00355' /></button>
					
					</ww:if>
					
					<!-- 返回 -->				
					<button   style="margin-top:-5px;" class="btn  btn-primary" onclick="a_win_local('returnmain.vs?show_menu=1')" type="button"><ww:property value='#session.local.a00013' /></button>
		          ...
		          <div id="pm_right_pro"  style="display: none;">
		              ...
		              <ul class="pm_right_content" id="pm_right_content_id" style="padding-left: 0px;background-color: rgb(238, 238, 238);">
			              ...
			              <li style="height: 35px;padding:5px 0px 0px 10px;">
			                   <input type='checkbox' checked="checked" class='menu-Sorption' onChange="1" id='Sorption' /><ww:property value="#session.local.b00165" /><br/><!-- 自动吸附 -->
			              </li>
			              ...
			              <ww:if test="#session.version_onoff.cllComponentOnOff==1">
				              ...
				              <li style="height: 35px;padding:5px 0px 0px 10px;">
				               ...
				               <li style="height: 35px;padding:5px 0px 0px 10px;">
				                   <input type='checkbox' checked="checked" class='' onChange="3"  id='relationCall' /><ww:property value="#session.local.b00363" /><br/><!--关联叫号组件 -->
				              </li>
...
<!--					    <button id="for_align_height" class="btn  btn-primary  btn-primary btn-mini"  type="button"><ww:property value="#session.local.b00167" /></button> -->
     ...
     <input type="hidden" id="itemid"  value="<ww:property value='itemid' />"  />

...
function many_submit()
{
	...
	//qmany|X*Y*宽*高*样式(1,2,3)*显示行数*字体大小*字体颜色*语音播放(0关 1开)*背景色 (0透明 )
    ...
    window.parent.returnValue="qmany|"+xy_x+"*"+xy_y+"*"+width+"*"+height+"*"+stype+"*"+sline+"*"+sdx+"*"+sys+"*"+svoice+"*"+sbjs; 
		   ...
		   <div class="result-wrap">
		          ...
		          <tr>
		            ...
		            <td>
		               <select id="sline" name="sline"> 
	                      <option  <ww:if test='sline==1'>selected="selected"</ww:if>  value="1">1</option>
			              <option  <ww:if test='sline==2'>selected="selected"</ww:if>  value="2">2</option>
			              <option  <ww:if test='sline==3'>selected="selected"</ww:if>  value="3">3</option>
			              <option  <ww:if test='sline==4'>selected="selected"</ww:if>  value="4">4</option>
			              <option  <ww:if test='sline==null||sline==5'>selected="selected"</ww:if>   value="5">5</option>
			              <option  <ww:if test='sline==6'>selected="selected"</ww:if>  value="6">6</option>
			              <option  <ww:if test='sline==7'>selected="selected"</ww:if>  value="7">7</option>
			              <option  <ww:if test='sline==8'>selected="selected"</ww:if>  value="8">8</option>
			              <option  <ww:if test='sline==9'>selected="selected"</ww:if>  value="9">9</option>
			              <option  <ww:if test='sline==10'>selected="selected"</ww:if>  value="10">10</option>
		               </select>
		            </td>
		          </tr>
		        ...
		        <tr>
				   ...
				   <tr style="height:50px;">
		            <td></td>
		            <td>
		               <input  type="button" onclick="many_submit()"  value="<ww:property value='#session.local.a00080' />" style=" width:80px ;color: #495764;font-family:Microsoft YaHei;"   class="button1" />
		               &nbsp;&nbsp; 
		               <input  type="button" onclick="many_return()"  value="<ww:property value='#session.local.a00014' />" style=" width:80px ;color: #495764;font-family:Microsoft YaHei;"   class="button1" />

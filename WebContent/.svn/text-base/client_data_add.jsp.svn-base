		                        ...
		                        <tbody>
		                          ...
		                          <tr>
		                              ...
		                              <td style="padding-top: 5px;padding-bottom: 5px;">
		                                     <textarea name="txtcontent" id="txtcontent"  rows="8"  cols="40"></textarea>
		                              </td>
		                           </tr>
		                            <!-- 样式 -->
		                            <tr>
		                            ...
		                            <th></th>
		                                <td>
											 ...
											 <select name="fs"  id="fs">
											        <option  selected="selected"  value="-1"><ww:property value="#session.local.b00226" /></option>
<!--												<option value="36"><ww:property value="#session.local.b00002" /></option>-->
											        ...
											        <option   value="36"><ww:property value="#session.local.b00040" /></option>

...
<html>
  <head>
   ...
   //按钮(点击选择ZIP)
   var upbutton="<ww:property value='#session.local.a00812'  />XLS";
   ...
   //显示(组ZIP)
   var a00790="<ww:property value='#session.local.a00803'  />xls";
 ...
 //资源存储空间不足,请联系管理员
   ...
   //上传地址   
   var upserver="toimportUser.vs";
   
   //上传格式
   var upextensions="xls";

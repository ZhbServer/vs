		                    ...
		                    <table class="insert-tab" width="100%" >
		                        <tbody>
		                         ...
		                         <tr style="height: 40px;">
	                                <th></th>
	                                <td>
<!--	                                      <input class="btn btn-primary btn6 mr10" style="width: 110px;height: 30px;"   value="<ww:property value='#session.local.a00080' />" type="button"  onclick="addjh()"/>-->
	                                    
	                                      <button onclick="addjh()"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00080' /></button>

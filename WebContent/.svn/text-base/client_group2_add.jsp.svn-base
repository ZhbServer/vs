...
function addcg2(){
	   ...
	   document.form1.action = 'adcg2.vs'; 
		                    ...
		                    <table class="insert-tab" width="100%">
		                        <tbody>
		                          <tr>
		                            ...
		                            <td>
		                                   <input  class="common-text required" id="cg2name" name="cg2name"    type="text"/>
		                            </td>
		                          </tr>
		                          ...
		                          <tr>
		                            ...
		                            <tr>
		                                <th></th>
		                                <td>
		                                    <input class="btn btn-primary btn6 mr10" value="<ww:property value='#session.local.a00080' />" type="button"  onclick="addcg2()"/>

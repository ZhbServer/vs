...
<script>
   ...
   function adPlayData(){
	   ...
	   //构造集合对象
  	   var programImageGroup=new Object();
  	   programImageGroup.mLeft=0;
  	   programImageGroup.mTop=0;
  	   programImageGroup.mWidth=300;
  	   programImageGroup.mHeight=300;
	   ...
	   programImageGroup.mMediaImageGroupMediaList=mMediaImageGroupMediaList;//素材播放列表
	   ...
	   // 类型
	   programImageGroup.type=16
	        
	   var json = JSON.stringify(programImageGroup);
    ...
    <form method="post" name="form1" action="">
       <div class="panel panel-primary" style="margin: 3px 3px;">
           <div class="panel-heading">
                <ww:property value="#session.local.b00127"/> <!-- 图片组 -->
           </div>
			            ...
			            <td  colspan="3"  style="padding-left: 20px;">
			                   ...
			                   <div id="targetDivContentImg" style="padding-top: 10px;">
						            ...
						            <div  style="float: left;padding: 0px 0px; width:400px;height:60px;margin-left: 60px;margin-top: 20px;">
						                <ww:property  value="#session.local.b00128"/>
						                <select id="imageGroupShowType" name="imageGroupShowType">
						                   <option value="0"> 
						                       <ww:property  value="#session.local.b00129"/><!-- 平铺 -->
						                   </option>
						                   <option value="1"> 
						                       <ww:property  value="#session.local.b00130"/><!-- 等比列 -->
						                   </option>
						                </select>
						                
						               &nbsp;&nbsp;&nbsp;&nbsp;
						               <ww:property  value="#session.local.b00131"/>
						               <select id="imageGroupScrollType" name="imageGroupScrollType">
						                   <option value="0"> 
						                       <ww:property  value="#session.local.b00132"/><!-- 静态 -->
						                   </option>
						                   <option value="1"> 
						                       <ww:property  value="#session.local.b00133"/><!-- 向左 -->
						                   </option>
						                   <option value="2"> 
						                       <ww:property  value="#session.local.b00134"/><!-- 向右-->
						                   </option>
						                </select>

...
<html>
  <head>
   ...
   //按钮(点击选择ZIP)
   var upbutton="<ww:property value='#session.local.a00812'  />ZIP";
   ...
   //显示(组ZIP)
   var a00790="<ww:property value='#session.local.a00803'  />ZIP";
   ...
   //显示(组)
   var a00800="<ww:property value='#session.local.a00803'  />";
 ...
 //资源存储空间不足,请联系管理员
   ...
   //上传地址   
   var upserver="<ww:property value='daoUrl'  />";
   
   //上传格式
   var upextensions="zip";
  ...
  <body  style="overflow: auto;" >
   <form>
          <div id="uploader">
	        ...
	        <span style="color: #FFA534;font-size: 13px;">&nbsp;&nbsp;&nbsp;&nbsp;<ww:property value="#session.local.b00373" /> </span>

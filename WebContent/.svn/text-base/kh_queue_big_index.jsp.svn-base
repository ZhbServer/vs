		 ...
		 -->	
			 ...
			 <div class="row">
			      <div class="btn-group" style="float: right;margin-right: 30px;">
				       <button onclick="onhref('toququebindbig.vs')"   type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00705' /></button><!-- 新增 -->
				       <button onclick="del_sel('delbig.vs')"        type="button" class="btn btn-sm btn-danger"><ww:property value='#session.local.a00025' /></button>
				   </div>	
			 </div>
        ...
        <div style="height: 400px;width: 1050px;" >
             ...
             <div style="padding-right:17px;margin: 0px;">
                 	<table border="0" cellpadding="0" cellspacing="0" style="margin: 0px;">
						...
						<td style="width:20%" ><ww:property value='#session.local.a00708' /></td><!-- 区号 -->
...
<!--							     <ww:property value="id" />-->
							  ...
							  <td style="width:20%" ><ww:property value="point"  /></td>
							  <td style="width:20%">

...
function editcg3(){
	   ...
	   document.form1.action = 'editcg3.vs'; 
...
<body>
   <form  name="form1" method="post" >
         <input type="hidden" value="<ww:property value='cg3.id' />" name="cg3id" />
		                    ...
		                    <table class="insert-tab" width="100%">
		                        <tbody>
		                         <tr>
		                            ...
		                            <td>
		                                   <input  class="common-text required" id="cg3name" name="cg3name"  value="<ww:property value='cg3.g3name' />"  type="text"/>
		                            </td>
		                          </tr>
		                          <tr>
		                            <th width="120"><i class="require-red">*</i><ww:property value='#session.local.a00235' />：</th>
		                            <td>
		                                     <select name="cg1id" onchange="ajax_get_cg2info(this.value)" >
		                                        <ww:iterator value="cg1s"> 
		                                           <option <ww:if test="id==cg3.pid">selected="selected"</ww:if>  value="<ww:property value='id' />"><ww:property value='gname' /></option>
		                                        </ww:iterator>											 
											 </select>
		                            </td>
		                          </tr>
		                           ...
		                           <tr>
		                            ...
		                            <tr>
		                                <th></th>
		                                <td>
		                                    <input class="btn btn-primary btn6 mr10" value="<ww:property value='#session.local.a00017' />" type="button"  onclick="editcg3()"/>

...
function open_send_jh(itemc,jhid,ocheck){
    ...
    layer.open({
        ...
        fix: false, //不固定
        shift: Math.ceil(Math.random()*6), //0-6的动画形式，-1不开启
        content:'tosendjh.vs?jhid='+jhid+"&jhtype=2",
        scrollbar: false,
        end: function(){ 
...
//导出计划
function open_dao_insert_jh(jhid){
	  ...
	  layer.open({
	        ...
	        fix: false, //不固定
	        shift: Math.ceil(Math.random()*6), //0-6的动画形式，-1不开启
	        content: 'daoinsertjh.vs?id='+jhid,
	        scrollbar: false,
	        end: function(){ 
...
function jhsee(jhid){
    ...
    window.location.href="jhinsertsee.vs?jhid="+jhid;   
...
<div class="title bottom">
		<div class="t_container">
			<div class="loc">
			       <ww:property value='#session.local.a00065' /> :<span class="function"><ww:property value='#session.local.a00645' /></span><span class="material_bg"><ww:property value='#session.local.a00648' /></span>
			</div>
		</div>
</div>
			  ...
			  <div class="row">
		         <div class="btn-group" style="float: right;margin-right:120px;">
			           ...
			           <select onchange="change_jh(this.value)"  class="form-control"  style="width: 100px;height: 30px;font-size: 12px;float: left;">
                          ...
                          <option  selected="selected" value="2"><ww:property value='#session.local.a00648' /></option>
            ...
            <div style="height: 400px;overflow: auto;overflow-y:scroll;">
              <table border="0" cellpadding="0" cellspacing="0" style="margin-top:0px;margin-bottom: 0px;width: 900px;">
					...
					<tr class="cell_element cell_show">
					  ...
					  <td width="30%"><span onclick="jhsee(<ww:property value='id' />)" style="cursor: pointer;"><ww:property value="name"/></span></td>
...
<!--                             -->
	                          ...
	                          <span title="<ww:property value='#session.local.a00022' />" onclick="open_add_jh(2,<ww:property value='id' />)" style="cursor: pointer;margin-right: 5px;">
	                           ...
	                           |
                              <!--  导出计划  -->
	                             <span title="<ww:property value='#session.local.b00209' />" onclick="open_dao_insert_jh(<ww:property value='id' />)" style="cursor: pointer;margin-right: 5px;">

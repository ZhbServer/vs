...
<html>
  <head>
   ...
   <script type="text/javascript">
	   ...
	   //按钮(点击选择视频)
	   var upbutton="<ww:property value='#session.local.a00810'  />";
	   ...
	   //显示(部视频)
	   var a00790="<ww:property value='#session.local.a00791'  />";
	   ...
	   //显示(部)
	   var a00800="<ww:property value='#session.local.a00801'  />";
	   ...
	   //上传地址
	   var upserver="upvideo.vs";
	   //上传格式
	   var upextensions="rm,rmvb,avi,mpeg,mpg,dat,mov,asf,mtv,mkv,wmv,3gp,mp4,amv,dmv,divx,flv";
	    ...
	    //mimeTypes  
	    var upmimeTypes=".rm,.rmvb,.avi,.mpeg,.mpg,.dat,.mov,.asf,.mtv,.mkv,.wmv,.3gp,.mp4,.amv,.dmv,.divx,.flv";
       ...
       <form>
	               <div id="uploader">
		                ...
		                <div class="statusBar" style="display:none;">
		                    ...
		                    <div class="btns">
		                        <div id="filePicker2"></div><div class="uploadBtn"><ww:property value='#session.local.a00808'  /></div><!-- 开始上传 -->
		                    </div>
		                </div>
	            </div>

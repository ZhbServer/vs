...
function openUploadApk(){
   layer.open({
        ...
        scrollbar: false,
    	   ...
    	   /*添加素材操作日志*/
    	   //getpartnodiv("addlogsucai.vs?sucaiType=1");
    	   /*刷新页面*/
    	   document.getElementById("id").value=1;
		   document.form1.target = "_self";
		   document.form1.action = "tosyscsapk.vs"; 
...
<!--		</div> 截屏 -->
       ...
       <ww:if test="#session.version_onoff.rssOnOff==1">
		...
		<div class="subNav_menu" onclick="change_syspar('tosyscsapk.vs')"  name='2' style="color:#ffffff; background-color:#007ccd;">
		    APK
		</div><!-- APK -->
	...
	<div class="c_right">
	    <div class="c_right_header" style="">
			 ...
			 <div class="row">
			      <div class="btn-group" style="float: right;margin-right: 10px;">
					   ...
					   <button style="margin-left: 20px;" onclick="openUploadApk()"   type="button" class="btn btn-sm btn-success"><ww:property value='#session.local.a00021' /></button><!-- 新增 -->
				       <button onclick="del_sel('delapk.vs')"        type="button" class="btn btn-sm btn-danger"><ww:property value='#session.local.a00025' /></button>
		...
		<div class="nav" >
			<ul class="pg">
                ...
                <!-- 上一页-->
				<li><a href="javascript:pageto(<ww:property value='qian' />,'tosyscsapk.vs');" class="pg_f"></a></li>
	            <!--页码显示上-->
				<ww:iterator id="q"  value="ps.qs">
	                  <li><a href="javascript:pageto(<ww:property value='#q'/>,'tosyscsapk.vs');" ><ww:property value="#q"  /></a> </li>
	            </ww:iterator>
	            
	            <!--当前页码-->
	            <li><a href="javascript:pageto(<ww:property value='#request.id'  />,'tosyscsapk.vs');" style="background-color:#FFA534;"><ww:property value="#request.id"  /></a> </li>
	            
	             <!--页码显示下-->
	            <ww:iterator id="h"  value="ps.hs">
	                  <li><a href="javascript:pageto(<ww:property value='#h'/>,'tosyscsapk.vs')"><ww:property value="#h"  /></a></li>
	            </ww:iterator>
	            
                <!--下一页-->
	            <li><a href="javascript:pageto(<ww:property value='hou' />,'tosyscsapk.vs');" class="pg_e"></a></li>
			</ul>
			...
			<div class="pg_count">
			     ...
			     <a href="javascript:setpagetype(10,'tosyscsapk.vs');" <ww:if test='#session.publicPagetype==10'>style="background-color:#FFA534;"</ww:if>  >10</a>
			     <a href="javascript:setpagetype(20,'tosyscsapk.vs');" <ww:if test='#session.publicPagetype==20'>style="background-color:#FFA534;"</ww:if> >20</a>
			     <a href="javascript:setpagetype(30,'tosyscsapk.vs');" <ww:if test='#session.publicPagetype==30'>style="background-color:#FFA534;"</ww:if> >30</a>
			     <a href="javascript:setpagetype(-1,'tosyscsapk.vs');" <ww:if test='#session.publicPagetype==-1'>style="background-color:#FFA534;"</ww:if> ><ww:property value='#session.local.a00815' /></a>
			</div>

          ...
          <div class="content_mid_1" style="text-align: center;">
             <div id="__01">
					...
					<div id="x672ax6807x9898-4-01-03" style="margin-top:30px;"> <!-- 成功logo-->
						<img src="images/success_client_stop.png" width="92" height="81" alt="">
					</div>
					
					
					<div id="x672ax6807x9898-4-01-06" style="margin-top:10px;"> <!--终端禁用-->
						
						<ww:property  value="#session.local.a00768"  />
					</div>
					
					
					<div id="x672ax6807x9898-4-01-09" style="margin-top:30px;"><!--进度条 -->
						<img src="images/success_bar_stop.png" width="412" height="8" alt="">
					</div>

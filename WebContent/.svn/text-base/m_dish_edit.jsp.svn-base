...
<html lang="zh-cn">
  ...
  <body onload="init_data()">
   ...
   <script type="text/javascript">
	    ...
	    function init_data(){
                ...
                dishArray=eval( "(" + dishArrayStr + ")" );//转换后的JSON对象
  ...
  <div class="yinghka_k">
    <ul>
        <li>
            <p>标题</p>
            <input type="text"   id="dishTitle"  name="dishTitle"   placeholder="" value="<ww:property  value='dish.title' />" >
            
            <input type="hidden"   id="dishEditId"  name="dishEditId"   placeholder="" value="<ww:property  value='dish.id' />" >
        </li>

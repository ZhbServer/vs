...
<div class="c_middle download_manager">
	...
	<div>
		<div class="material_show_left" style="margin:10px 0px 0px 100px;">
				<ul>
				<li>
					<button  onclick="selscpc('1')" class="btn btn-sm btn-primary" style="width:80px;" type="button"><ww:property value='#session.local.a00058' /></button>
				</li>
				<li>
			...
			<div class="row">
	         <div style="float:left;margin:10px 0px 10px 70px;width:1050px;">
	         	  ...
	         	  <div class="col-xs-3" style="margin-left: -110px;">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <input  style="margin-top: -1px;"  type="radio" name="choicedate"  value="2"/><ww:property value='#session.local.a00857' />&nbsp;<!-- 本周 -->
                    &nbsp;&nbsp;&nbsp;
                    <input  style="margin-top: -1px;"  type="radio" name="choicedate"  value="3"/><ww:property value='#session.local.a00854' />&nbsp;<!-- 本月 -->
                    &nbsp;&nbsp;&nbsp;
                    <input  style="margin-top: -1px;"  type="radio" name="choicedate"  value="4"/><ww:property value='#session.local.a00855' />&nbsp;<!-- 本年 -->
	         	  </div>

...
<div class="title bottom">
	<div class="t_container">
			<div class="loc">
			       <ww:property value='#session.local.a00065' /> :<span class="function"><ww:property value='#session.local.a00007' /></span><span class="material_bg"><ww:property value='#session.local.a00061' /></span>
			</div>
		    ...
		    <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				     	<button class="btn btn-sm btn-primary" onclick="replace_sucai_list('tosclist.vs?sucai.type=3&pagetype=10&showtype=1')" type="button"><ww:property value='#session.local.a00069' /></button>
				     	<ww:if test="isSelf!=0">
				  		     <button onclick="add_share('addshare.vs',3)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00816' /></button>
				  		</ww:if>
				  </div> 
				   ...
				   <ww:if test="isSelf!=0">
					   <div class="btn-group" style="float: right;margin-right: 30px;">
						  ...
						  <button onclick="openUpload('upvideo.jsp',3)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00063' /></button>

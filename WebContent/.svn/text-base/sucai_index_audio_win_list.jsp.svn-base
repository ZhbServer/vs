...
<div class="title bottom">
	<div class="t_container">
			<div class="loc">
			       <ww:property value='#session.local.a00065' /> :<span class="function"><ww:property value='#session.local.a00007' /></span><span class="material_bg"><ww:property value='#session.local.a00059' /></span>
			</div>
		    ...
		    <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				     	<button class="btn btn-sm btn-primary" onclick="replace_sucai_list('tosclist.vs?sucai.type=2&pagetype=10&showtype=1')" type="button"><ww:property value='#session.local.a00069' /></button>
				     	<ww:if test="isSelf!=0">
				  		     <button onclick="add_share('addshare.vs',2)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00816' /></button>
				  		</ww:if>
				  </div> 
				   ...
				   <div class="btn-group" style="float: right;margin-right: 30px;">
				      <button id="selectAll" type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00019' /></button>
					  <button onclick="openUpload('upaudio.jsp',2)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00063' /></button>
        ...
        <div class="con" id="con" style="overflow: auto;height: 410px;"  >
    	   <ul class="display_container" style="padding-left: 0px;">
    	    ...
    	    <ww:iterator value="listsc" status="status">
    	         ...
    	         <li  ondblclick="yulan('seevideo.vs?scid=<ww:property value='id' />')"
    	         ...
    	         <div class="text">
    	             ...
    	             <span>&nbsp;&nbsp;<ww:property value='#session.local.a00105' />:<ww:property value="stime"/><ww:property value='#session.local.a00106' /></span><br />

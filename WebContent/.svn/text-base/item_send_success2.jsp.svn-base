          ...
          <div class="content_mid_1" style="text-align: center;">
             <div id="__01">
					...
					<div id="x672ax6807x9898-4-01-03" style="margin-top:30px;"> <!-- 成功logo-->
						<img src="images/success_file_exit.png" width="92" height="81" alt="">
					</div>
					
					
					<div id="x672ax6807x9898-4-01-06" style="margin-top:10px;"> <!--文件不存在-->
						
						<ww:property value="#session.local.a00598"/>
					</div>
					
					
					<div id="x672ax6807x9898-4-01-09" style="margin-top:30px;">
						丢失节目/文件:<ww:property value="lostFileName"/>
					</div>

 ...
 function send_item(){
  ...
  function validity_send(){
	  ...
	  layer.open({
	        ...
	        content: "item_client_date_send.jsp",
	        scrollbar: false,
	        end: function(){ 
...
<div class="mainframe clearfix user_list" id="mainCenter" style="color:red;height: 510px;">
            	<div class="mainCInLeft" style="height: 510px;width: 215px;">
					...
					<%
						...
						jw.print("&nbsp;&nbsp;<img src='image/jt1.gif'  width='5px'  height='10px' />&nbsp;<input type='checkbox' name='curruserid' style='line-height:40px;margin-right:5px;margin-top:10px;' id='curruserid'  value='0,0'/>"+Constant.LOCAL.getA00815());
						jw.print("</a>");
			     ...
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				   ...
				   <div class="btn-group" style="float: right;margin-right: 30px;">
				      <ww:if test="fbtype==1">
						  <button onclick="send_item()"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00639' /></button>
						  <button onclick="validity_send()"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00421' /></button>
			          </ww:if>
		        ...
		        <div style="height: 400px;"  >
                    ...
                    <div style="padding-right:17px;margin: 0px;">
                         <table border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 0px;">
							...
							<td style="width: 30%;" ><ww:property value='#session.local.a00133' /></td>

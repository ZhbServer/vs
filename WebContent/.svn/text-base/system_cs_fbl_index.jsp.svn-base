...
function open_fbl_add(){
	layer.open({
         ...
         scrollbar: false,
		   ...
		   document.form1.action = "tosyscsfbl.vs"; 
...
<div class="title bottom">
		<div class="t_container" >
			<div class="loc">
			        ...
			        <span class="material_bg"><ww:property value='#session.local.a00176' /></span>
			</div>
		</div>
</div>
...
<div class="c_middle download_manager">
    ...
    <div class="c_left" >
		...
		<div class="subNav_menu" onclick="change_syspar('tosyscsfbl.vs')"  name='0' style="color:#ffffff; background-color:#007ccd;">
...
<!--		</div> 截屏 -->
	...
	<div class="c_right">
	    <div class="c_right_header" style="">
			 ...
			 <div class="row">
			      <div class="btn-group" style="float: right;margin-right: 10px;">
					   ...
					   <button style="margin-left: 20px;" onclick="open_fbl_add()"   type="button" class="btn btn-sm btn-success"><ww:property value='#session.local.a00021' /></button><!-- 新增 -->
				       <button onclick="del_sel('delfbl.vs')"   type="button" class="btn btn-sm btn-danger"><ww:property value='#session.local.a00025' /></button>
				   </div>	
			 </div>
             ...
             <div style="padding-right:17px;margin: 0px;">
                <table border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 0px;margin-top: 0px;">
                    <tr class="cell_element cell_first">
						...
						<td style="width: 20%;"><ww:property value='#session.local.a00033' /></td>
				    </tr>
                </table>
            </div>
				 ...
				 <table border="0" cellpadding="0" cellspacing="0" style="margin: 0px;" >
			         <ww:iterator value="fbls">
				            <tr class="cell_element cell_show">
								  ...
								  <td  style="width: 10%;">
								     <ww:property value="tx"  />
								  </td>
								  <td  style="width: 20%;">
								     <ww:property value="ty"  />
								  </td>
							</tr>
					</ww:iterator>
			     </table>
		...
		<div class="nav" >
			<ul class="pg">
                <!-- 上一页-->
				<li><a href="javascript:pageto(<ww:property value='qian' />,'tosyscsfbl.vs');" class="pg_f"></a></li>
	            <!--页码显示上-->
				<ww:iterator id="q"  value="ps.qs">
	                  <li><a href="javascript:pageto(<ww:property value='#q'/>,'tosyscsfbl.vs');" ><ww:property value="#q"  /></a> </li>
	            </ww:iterator>
	            
	            <!--当前页码-->
	            <li><a href="javascript:pageto(<ww:property value='#request.id'  />,'tosyscsfbl.vs');" style="background-color:#FFA534;"><ww:property value="#request.id"  /></a> </li>
	            
	             <!--页码显示下-->
	            <ww:iterator id="h"  value="ps.hs">
	                  <li><a href="javascript:pageto(<ww:property value='#h'/>,'tosyscsfbl.vs')"><ww:property value="#h"  /></a></li>
	            </ww:iterator>
	            
                <!--下一页-->
	            <li><a href="javascript:pageto(<ww:property value='hou' />,'tosyscsfbl.vs');" class="pg_e"></a></li>
			</ul>
			...
			<div class="pg_count">
			     ...
			     <a href="javascript:setpagetype(10,'tosyscsfbl.vs');" <ww:if test='#session.publicPagetype==10'>style="background-color:#FFA534;"</ww:if>  >10</a>
			     <a href="javascript:setpagetype(20,'tosyscsfbl.vs');" <ww:if test='#session.publicPagetype==20'>style="background-color:#FFA534;"</ww:if> >20</a>
			     <a href="javascript:setpagetype(30,'tosyscsfbl.vs');" <ww:if test='#session.publicPagetype==30'>style="background-color:#FFA534;"</ww:if> >30</a>
			     <a href="javascript:setpagetype(-1,'tosyscsfbl.vs');" <ww:if test='#session.publicPagetype==-1'>style="background-color:#FFA534;"</ww:if> ><ww:property value='#session.local.a00815' /></a>

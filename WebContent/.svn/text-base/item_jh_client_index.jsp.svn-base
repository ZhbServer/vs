...
<script type="text/javascript">
  ...
  function jh_send(){
      ...
      //获取计划类型 1轮播 2插播 3有效期发布
      var jhtype=document.getElementById("jhtype").value;
	  if(jhtype==3){
		  document.form1.action="sendjh.vs";
		  ...
		  $.ajax({
				 ...
				 data:{
				     ...
				     success:function(data) {
						 var json = eval(data.count);
						 if(json > 0){
							 layer.confirm("<ww:property value='#session.local.a00858' />?", {icon: 3, title:"<ww:property value='#session.local.a00093' />",btn: ["<ww:property value='#session.local.a00080' />", "<ww:property value='#session.local.a00014' />"]}, function(index,layero){
								 document.form1.action="sendtimejh.vs";
								 document.form1.submit();
						     });
						 }else{
							 document.form1.action="sendtimejh.vs";
		  ...
		  document.form1.action="sendinsertjh.vs";
		  document.form1.submit();

	  }else if(jhtype==4){

		  document.form1.action="senddpjh.vs";
		  document.form1.submit();
			     ...
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-3" style="margin-left: -28px;" >
				     	 <ww:if test="jhtype==3">
						    ...
						    <!-- 发布模式 -->
						    <ww:property value="#session.local.a00640"/>
						     :&nbsp;
						    <input type="radio" name="vfbmode"  value="0"/><ww:property value="#session.local.a00637"/>&nbsp;<!--替换  -->    
						    <input type="radio" name="vfbmode" checked="checked"  value="1"/><ww:property value="#session.local.a00636"/> <!--追加   -->
...
<input type="hidden" value="<ww:property value='jhid'/>" name="jhid"  id="jhid" />                    <!-- 计划ids -->
...
<input type="hidden" value="<ww:property value='jhtype'/>" name="jhtype" id="jhtype"/>                <!-- 发布类型 --> 

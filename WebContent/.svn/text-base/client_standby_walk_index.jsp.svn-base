...
var intro;
  ...
  function plan_add(){
	  layer.open({
	         ...
	         fix: false, //不固定
	         shift: Math.ceil(Math.random()*6), //0-6的动画形式，-1不开启
	         content: 'client_standby_walk_add.jsp',
	         scrollbar: false,
	         end: function(){
				  if(window.returnValue==undefined||window.returnValue==""){
					   window.returnValue=""; 
						...
						document.form1.action = "tostandbywalk.vs"; 
						document.form1.submit(); 
				  }    
	 		 }
	 	});   
  ...
  function plan_onoff_send(){
	  var task=document.getElementById("task").value;
 	  ...
 	  document.form1.action="fbstandbywalk.vs";
      document.form1.submit();
  }
  ...
  function onoff_del(theone){
		...
		document.form1.action = "standbywalkdel.vs"; 
		document.form1.submit(); 
  ...
  function onoff_edit(theone){
	  ...
	  layer.open({
	         ...
	         fix: false, //不固定
	         shift: Math.ceil(Math.random()*6), //0-6的动画形式，-1不开启
	         content: 'tostandbywalkedit.vs?selonoff='+theone,
	         scrollbar: false,
	         end: function(){
				  if(window.returnValue==undefined||window.returnValue==""){
					   window.returnValue=""; 
		 ...
		 <div class="title bottom">
				<div class="t_container">
				    <div class="loc">
					        ...
					        <span class="material_bg"><ww:property value='#session.local.b00309' /></span>
					</div>
							        ...
							        <ww:iterator value="ls">
										 <tr class="cell_element cell_show">
												...
												<td style="width:30%"  align="center">
												  ...
												  <ww:if test="type==1">
												       <ww:property value="#session.local.a00487" />
												  </ww:if>

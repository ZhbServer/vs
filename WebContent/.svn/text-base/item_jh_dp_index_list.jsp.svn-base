...
function open_send_jh(itemc,jhid,ocheck){
    ...
    layer.open({
        ...
        fix: false, //不固定
        shift: Math.ceil(Math.random()*6), //0-6的动画形式，-1不开启
        content:'tosendjh.vs?jhid='+jhid+"&jhtype=4",
        scrollbar: false,
        end: function(){ 
...
function jhsee(jhid){
    ...
    window.location.href="jhdpsee.vs?jhid="+jhid;   
...
<div class="title bottom">
		<div class="t_container">
			<div class="loc">
			       <ww:property value='#session.local.a00065' /> :<span class="function"><ww:property value='#session.local.a00645' /></span><span class="material_bg"><ww:property value='#session.local.b00310' /></span>
			</div>
		</div>
 </div>
...
<!--		         	  <button onclick="change_jh(3)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00646' /></button> 普通计划 -->
                       ...
                       <select onchange="change_jh(this.value)"  class="form-control"  style="width: 100px;height: 30px;font-size: 12px;float: left;">
                          ...
                          <option selected="selected" value="4"><ww:property value='#session.local.b00310' /></option>
           ...
           <!-- 固定标题 -->
            <div style="padding-right:17px;margin: 0px;">
               <table border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 0px;width: 900px;">
					...
					<td width="10%" style="display: none;"><ww:property value='#session.local.a00217' /></td>

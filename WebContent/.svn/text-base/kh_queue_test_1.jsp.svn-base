...
<script>
	function queue_click() {
		...
		document.form1.action = "apiQueuing.vs?"+queuess;
...
<body>
   <form  name="form1" method="post" >
		<div id="part_one" class="part_one">
		         ...
		         叫号姓名:<input  name="nname"  value="张三"/><br/>
		                   科室:<input  name="ndepartments"  value="呼吸内科"/><br/>
		                   诊台:<input  name="ndiagnostic"  value="2"/><br/>

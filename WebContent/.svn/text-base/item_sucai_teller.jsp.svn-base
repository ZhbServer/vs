...
<script>
      ...
      function onload_data(){
    	    ...
    	    if(layerBigDataParameter!=""){
        		...
        		var tellerKey="<ww:property value='tellerKey' />";

        		$("#tellerKey").val(tellerKey);
   ...
   function adPlayData(){
	   ...
	   var tellerKey = $("#tellerKey").val();

	   if(tellerKey.length==0){

		   layer.msg("key"+"<ww:property value='#session.local.a00691'/>");  
           return;
	   }
	   ...
	   for(var i=0;i<rows.length;i++)
 	   {
	 	   ...
	 	   if(rows.length==1&&rows[i].tScName=="img_bg.png"){
			   ...
			   if(rows[i].tScName!="img_bg.png"){
				   ...
				   scBasis.inAnim=rows[i].tScTx;   //特效
				   scBasis.sname=rows[i].tScName;//显示名称
				   scBasis.relationKey=rows[i].tTellerNum;//柜员编号
				   mPlayTimes=mPlayTimes+parseInt(rows[i].tScTime);//播放时长
				   mMediaList[mMediaList.length]=scBasis;
	   ...
	   programComplexMediaManager.tellerKey=$("#tellerKey").val();
    ...
    <form method="post" name="form1" action="">
       <div class="panel panel-primary" style="margin: 3px 3px;">
           <div class="panel-heading">
                <ww:property value="#session.local.b00361"/> <!-- 柜员组件 -->
           </div>
			                   ...
			                   <div id="targetDivContentImg" style="padding-top: 10px;">
						            ...
						            <div  style="float: left;margin: 0px 0px; padding: 0px 0px;" >
						                 <table  id="dgPlay" class="easyui-datagrid"  title="<ww:property value="#session.local.b00013"  />" style="width:400px;height:390px;margin: 0px;padding: 0px;"
							                ...
							                <thead>
								                    <tr>
														...
														<th data-options="field:'tScName',width:180,sortable:true"><ww:property value='#session.local.a00133'/></th>
														<th data-options="field:'tScFileName',hidden:true"></th>
														<th data-options="field:'tTellerNum',width:180,
														...
														"><ww:property value='#session.local.b00369 '/></th><!--柜员编号 -->
														<th data-options="field:'tScTime',width:80,hidden:true,
														...
														<th data-options="field:'tScTx',width:100,formatter:unitformatter,hidden:true,
                                                             editor: 
                                                               { type: 'combobox', 
                                                                 options: 
                                                                        {  
							          ...
							          <div id="tb" style="height:auto;line-height: 0px;">
							                    ...
							                    key: <input id="tellerKey" class="easyui-textboxs" style="width:80px" />

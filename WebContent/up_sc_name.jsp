...
function upclient(){
     ...
     var nameVar = document.getElementById("scname").value;	
     if(nameVar.length < 1){
		    layer.msg("<ww:property value='#session.local.b00006' />!");
            return;
     }
     document.form1.target = "_self";
	 document.form1.action = 'toupscnames.vs'; 
		                    ...
		                    <table class="insert-tab" width="100%">
		                        <tbody>
		                            <tr>
			                            ...
			                            <td>
			                               <input class="common-text required" id="scname" name="scname"  value="<ww:property value='scname'/>"  type="text"/><span style="color: red;"></span>
			                               <input type="hidden" value="<ww:property value='id' />" name="id" />
			                            </td>
		                            </tr>

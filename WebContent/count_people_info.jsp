...
<script>
  ...
  //导出人脸识别数据 0  导出wife数据 1
  function OutPeoplo(id)
  {
	  ...
	  layer.open({
	        ...
	        content: 'outXXCountPeople.vs?&ser='+id+'&mark='+document.getElementById("mark").value+'&btime='+document.getElementById("btime").value+'&etime='+document.getElementById("etime").value,
	        scrollbar: false,
	        end: function(){ 
	...
	<div>		
        ...
        <div style="height: 400px;text-align:center;">
          ...
          <div style="padding-right:17px;">
          		<%-- <button class="btn btn-sm btn-primary" name="faceOut" onclick="OutPeoplo(0)" style="width:10%;float:right;" type="button"><ww:property value='#session.local.a00658' /><ww:property value='#session.local.b00112' /></button>
				<button class="btn btn-sm btn-primary" name="wifeOut" onclick="OutPeoplo(1)"style="width:10%;float:right;" type="button"><ww:property value='#session.local.a00658'/>WIFE</button> --%>
	            <table border="0" cellspacing="0" cellpadding="0">
	              <tr class="cell_element cell_first">
					<td style="width:30%"><ww:property value='#session.local.a00248' /></td>
					<td style="width:30%"><ww:property value='#session.local.b00116' /></td>
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<ww:iterator value="countPeopleList">
						...
						<tr class="cell_element cell_show">
						  <td style="width:30%"><ww:property value='countDate' /></td>
						  <td style="width:30%"><ww:property value='countPeople' /></td>
						  <td style="width:20%">
						     <!-- 查看详情 -->

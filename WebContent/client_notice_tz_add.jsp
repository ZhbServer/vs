...
function save() {
    ...
    document.form1.action="addnotice.vs";
		                        ...
		                        <tbody>
		                         ...
		                         <tr>
		                          ...
		                          <tr>
		                                ...
		                                <td>
		                                     <textarea name="fontcontent" id="fontcontent"  rows="4"  cols="40"></textarea>
		                                </td>
		                           </tr>
		                            <!-- 样式 -->
		                            <tr>
...
<!--										     <ww:property value='#session.local.a00539' />-->
										     ...
										     <input type="radio"  value="1" name="noticePostion" />
										     <ww:property value="#session.local.b00202"/>        
										     <!-- 顶部 -->           
										     &nbsp;        
										     <input type="radio"  value="0.5"  name="noticePostion"/>
										     <ww:property value="#session.local.b00203"/>      
										     <!-- 中部 -->        
										     &nbsp;        
										     <input type="radio"  value="0"   name="noticePostion"  checked="checked"/>
										     ...
										     &nbsp;        
										     <input type="radio"  value="-2"   name="noticePostion"  />

...
<div class="title bottom">
		<div class="t_container">
			<div class="loc">
			       <ww:property value='#session.local.a00065' /> :<span class="function"><ww:property value='#session.local.a00007' /></span><span class="material_bg"><ww:property value='#session.local.a00062' /></span>
			</div>
		   ...
		   <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-4" style="margin-left: -120px;">
				     	<button class="btn btn-sm btn-primary" onclick="replace_sucai_list('tosclist.vs?sucai.type=10&pagetype=12&showtype=2')" type="button"><ww:property value='#session.local.a00070' /></button>
				     	<ww:if test="isSelf!=0">
				  		     <button onclick="add_share('addshare.vs',10)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00816' /></button>
				  		</ww:if>
				  </div> 
				  
				   <ww:if test="isSelf!=0">
					   <div class="btn-group" style="float: right;margin-right: 30px;">
						  <button onclick="openUpload('uptxt.jsp',10)"  type="button" class="btn btn-sm btn-primary"><ww:property value='#session.local.a00063' /></button>
			  ...
			  <table border="0" cellpadding="0" cellspacing="0">
				 <ww:iterator value="listsc">
					...
					<tr class="cell_element cell_show">
					  ...
					  <td style="width:10%" ><a href="javascript:yulan('seetxt.vs?scid=<ww:property value='id' />');" class="pre_pic"><img width="40" height="25" src="image/txt_icon.png"  alt="<ww:property value='#session.local.a00026' />"/><div class="zoom"></div></a></td>

...
<div class="title bottom">
		<div class="t_container">
			<div class="loc">
		            ...
		            <span class="function"><ww:property value='#session.local.a00434' /></span>
...
<div class="c_middle download_manager">
		<div class="c_right_header" >
			<div class="col-xs-2" style="margin-left: 965px;" >
		     	<button  onclick="saveScshare('saveinteractitemshare.vs')" class="btn btn-sm btn-primary" type="button" style="padding: 4px 8px;"><ww:property value='#session.local.a00080' /></button>
		    	<button  onclick="delScshare('delinteractitemshare.vs')" class="btn btn-sm btn-danger" type="button" style="padding: 4px 8px;"><ww:property value='#session.local.a00670' /></button>
		    </div> 
		</div>
        <!--显示内容-->
		...
		<div class="nav" style="width: 1000px;margin-left:40px;margin-top: 10px;">
			<ul class="pg">
                <!-- 上一页-->
				<li><a href="javascript:pageto(<ww:property value='qian' />,'addinteractitemshare.vs');" class="pg_f"></a></li>
	            <!--页码显示上-->
				<ww:iterator id="q"  value="ps.qs">
	                  <li><a href="javascript:pageto(<ww:property value='#q'/>,'addinteractitemshare.vs');" ><ww:property value="#q"  /></a> </li>
	            </ww:iterator>
	            
	            <!--当前页码-->
	            <li><a href="javascript:pageto(<ww:property value='#request.id'  />,'addinteractitemshare.vs');" style="background-color:#FFA534;"><ww:property value="#request.id"  /></a> </li>
	            
	             <!--页码显示下-->
	            <ww:iterator id="h"  value="ps.hs">
	                  <li><a href="javascript:pageto(<ww:property value='#h'/>,'addinteractitemshare.vs')"><ww:property value="#h"  /></a></li>
	            </ww:iterator>
	            
                <!--下一页-->
	            <li><a href="javascript:pageto(<ww:property value='hou' />,'addinteractitemshare.vs');" class="pg_e"></a></li>
			</ul>
			...
			<div class="pg_count">
			     ...
			     <a href="javascript:setpagetype(10,'addinteractitemshare.vs');" <ww:if test='#session.publicPagetype==10'>style="background-color:#FFA534;"</ww:if>  >10</a>
			     <a href="javascript:setpagetype(20,'addinteractitemshare.vs');" <ww:if test='#session.publicPagetype==20'>style="background-color:#FFA534;"</ww:if> >20</a>
			     <a href="javascript:setpagetype(30,'addinteractitemshare.vs');" <ww:if test='#session.publicPagetype==30'>style="background-color:#FFA534;"</ww:if> >30</a>
			     <a href="javascript:setpagetype(-1,'addinteractitemshare.vs');" <ww:if test='#session.publicPagetype==-1'>style="background-color:#FFA534;"</ww:if> ><ww:property value='#session.local.a00815' /></a>
			</div>

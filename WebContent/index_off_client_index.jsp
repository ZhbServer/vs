			 ...
			 <div class="row">
			     <div class="col-xs-1">
				  ...
				  <div class="col-xs-3" style="margin-left: -70px;" >
				     	<button  onclick="sel_ser_client_index('offclient.vs')" class="btn btn-sm btn-primary" type="button" style="padding: 4px 8px;"><i class="icon icon-search"></i></button>
				  </div> 
				
			       
				 <div   style="float: right;margin-right: 50px;">
			         <select id="orderv" name="orderv"   class="form-control input-sm"  style="width: 110px;"  onchange="sel_ser_client_index('offclient.vs')">
			             <!-- 默认排序 -->
             ...
             <div style="padding-right:17px;margin-left: 30px;">
                <table style="text-align: center;margin: 0px;" border="0" cellpadding="0" cellspacing="0">
					<tr class="cell_element cell_first">
				        ...
				        <td width="20%"><ww:property value='#session.local.d00024' /></td><!-- 终端编号 -->
						<td style="width:20%" ><ww:property value='#session.local.a00040' /></td><!-- 标识码  -->
						<td style="width:15%" ><ww:property value='#session.local.a00039' /></td><!-- IP  -->
<!--					<td style="width:15%" ><ww:property value='#session.local.a00042' /></td> 连接时间  -->
						<td style="width:15%" ><ww:property value='#session.local.a00043' /></td><!-- 在线状态 -->
<!--					<td style="width:20%" ><ww:property value='#session.local.a00458' /></td> 版本号 -->
                        <td style="width:10%;text-align:left;" ><ww:property value='#session.local.a00016' /></td><!-- 操作 -->
...
<!--						  </td>-->
		...
		<div class="nav" style="width: 1000px;margin-left:20px;">
			<ul class="pg">
                <!-- 上一页-->
				<li><a href="javascript:pageto(<ww:property value='qian' />,'offclient.vs');" class="pg_f"></a></li>
	            <!--页码显示上-->
				<ww:iterator id="q"  value="ps.qs">
	                  <li><a href="javascript:pageto(<ww:property value='#q'/>,'offclient.vs');" ><ww:property value="#q"  /></a> </li>
	            </ww:iterator>
	            <!--当前页码-->
	            <li><a href="javascript:pageto(<ww:property value='#request.id'  />,'offclient.vs');" style="background-color:#FFA534;"><ww:property value="#request.id"  /></a> </li>
	            
	             <!--页码显示下-->
	            <ww:iterator id="h"  value="ps.hs">
	                  <li><a href="javascript:pageto(<ww:property value='#h'/>,'offclient.vs')"><ww:property value="#h"  /></a></li>
	            </ww:iterator>
	            
                <!--下一页-->
	            <li><a href="javascript:pageto(<ww:property value='hou' />,'offclient.vs');" class="pg_e"></a></li>
			</ul>
			...
			<div class="pg_count">
			     ...
			     <a href="javascript:setpagetype(10,'offclient.vs');" <ww:if test='pagetype==10'>style="background-color:#FFA534;"</ww:if> >10</a>
			     <a href="javascript:setpagetype(20,'offclient.vs');" <ww:if test='pagetype==20'>style="background-color:#FFA534;"</ww:if> >20</a>
			     <a href="javascript:setpagetype(30,'offclient.vs');" <ww:if test='pagetype==30'>style="background-color:#FFA534;"</ww:if> >30</a>
			     <a href="javascript:setpagetype(<ww:property value='total'/>,'offclient.vs');" <ww:if test='pagetype==total'>style="background-color:#FFA534;"</ww:if> ><ww:property value='#session.local.a00815' /></a>

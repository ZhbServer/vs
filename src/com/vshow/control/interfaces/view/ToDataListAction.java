...
public class ToDataListAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		user.setTkey(tkey);
		total = (Integer) sm.queryForObject("sel_data_all_son_count",user);
		...
		dlltxts = sm.queryForList("sel_data_all_son", user);
	...
	public List<DllTxt> getDlltxts() {
		return dlltxts;
	}

	public void setDlltxts(List<DllTxt> dlltxts) {
		this.dlltxts = dlltxts;
	}

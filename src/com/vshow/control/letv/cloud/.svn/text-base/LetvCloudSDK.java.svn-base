...
public class LetvCloudSDK {	
	    ...
	    public LetvCloudSDK(String userUnique, String secretKey) {
         ...
         * @throws Exception 
         */
        public String videoDownload(String video_id) throws Exception{
        	String api = "video.download";
        	HashMap<Object, Object> params = new HashMap<Object, Object>();

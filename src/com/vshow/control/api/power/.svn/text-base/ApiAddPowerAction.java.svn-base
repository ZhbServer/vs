 ...
 *
 */
public class ApiAddPowerAction implements Action {
	...
	public String execute() throws Exception {
		...
		if (user == null) {
			...
			if (user.getBan() == 0) {
				...
				try {
					SqlConnect.getSqlMapInstance().insert("add_power", power);
					LogHandle.insertTheLog(LogType.type56, user.getId(),Constant.LOCAL.getA00171()+":" + power.getName(), 1,1);
					code = "2";
				} catch (Exception e) {

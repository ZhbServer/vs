 ...
 *
 */
public class SetDevicePlayItemAction extends BaseAction {

	
	private Integer areaCode;  //区域表示/分组id 0表示默认
	private String  deviceMark;//终端标识
	private String  itemFileName; //需要播放的filename
				 ...
				 if(client==null){
					 ...
					 if(client.getZxstate()==1){
						 ...
						 if (mt != null) {
				        	 ...
				        	 protocol.setType(ProtocolType.TYPE72);
				        	 
				        	 protocol.setProtocolPlayStitching(itemFileName);

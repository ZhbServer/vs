 ...
 *
 */
public class ApiDownSetAction extends ActionSupport{
		...
		if (user == null) {
			...
			if (user.getBan() == 0) {
				...
				try{	
					...
					if(tmidsset.size()>0){
						String ts = "xiansu!" + speed;
						String tname = Constant.LOCAL.getA00470()+":" + speed + "K";
						
						Log log = LogHandle.insertTheLogSend(LogType.type30, user.getId(),tname,1);

 ...
 *
 */
public class ApiConNoverTimeAction extends ActionSupport{
			...
			if (user.getBan() == 0) {
				...
				try{	
					...
					if(tmidsset.size()>0){
						...
						String tname = Constant.LOCAL.getA00469()+":" + con+Constant.LOCAL.getA00106();
						Log log = LogHandle.insertTheLogSend(LogType.type31, user.getId(),tname,1);

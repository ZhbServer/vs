 ...
 *
 */
public class ApiAddSucaiGroupAction implements Action {
			...
			if (user.getBan() == 0) {
				try {
					...
					if(exist > 0){
						...
						SqlConnect.getSqlMapInstance().insert("add_group", scg);
						...
						LogHandle.insertTheLog(LogType.type3, user.getId(), Constant.LOCAL.getA00097()

 ...
 *
 */
public class ApiSelFblAction extends ActionSupport {

	private String password;
	private String account;
	private String content;

	private List<Fbl> fbllist;
	...
	public String execute() throws Exception {
		...
		if (user == null) {
			...
			if (user.getBan() == 0) {
				fbllist=(List<Fbl>)SqlConnect.getSqlMapInstance().queryForList("sel_fbl_all");
				if (fbllist != null) {
					code = "2";
				} else {
					code = "3";

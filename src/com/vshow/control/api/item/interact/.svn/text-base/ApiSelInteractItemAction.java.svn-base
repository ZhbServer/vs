 ...
 *
 */
public class ApiSelInteractItemAction extends ActionSupport {

	private String password;
	private String account;
	private String content;

	private List<InteractItem> interactitemlist;
	...
	public String execute() throws Exception {
		...
		if (user == null) {
			...
			if (user.getBan() == 0) {
				interactitemlist = (List<InteractItem>) SqlConnect.getSqlMapInstance()
				.queryForList("sel_interactitem_byUser", user);
				if(interactitemlist !=null){
					code = "2";
				}else{
					code = "3";
				}
		...
		map.put("code", code);
		map.put("interactitemlist", interactitemlist);

 ...
 *
 */
public class ApiRevokeItemAction extends ActionSupport{
		...
		if (user == null) {
			...
			if (user.getBan() == 0) {
				...
				try{	
					...
					String tname = Constant.LOCAL.getA00777()+":" + names;
					Log log = LogHandle.insertTheLogSend(LogType.type97, user.getId(),tname,1);

 ...
 *
 */
public class ApiCleanItemAction extends ActionSupport{
		...
		if (user == null) {
			...
			if (user.getBan() == 0) {
				...
				try{	
					...
					String tname = Constant.LOCAL.getA00530()+"["+Constant.LOCAL.getA00533()+"]";
					Log log = LogHandle.insertTheLogSend(LogType.type35, user.getId(),tname,1);

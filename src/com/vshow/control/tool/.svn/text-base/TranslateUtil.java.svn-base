...
public class TranslateUtil {
	...
	public static final String AUTO = "auto"; // google自動判斷來源語系
	...
	public static final String KOREAN = "ko"; // 韩
	...
	public static String ch2en(final String text) throws Exception {
		return translate(text, CHINA, ENGLISH);
	}
	
	public static void main(String[] args) throws Exception {
		System.out.println(tw2jp("晴"));
	}

...
public class DateUtil {
	...
	private final static SimpleDateFormat sdfTime2 = new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss");
	...
	* @author luguosui
	 ...
	 * @return
	 */
	public static boolean isValidDateHHmmss(String s) {

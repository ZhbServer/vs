...
public class ProjectionListAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		total=(Integer)sm.queryForObject("see_projection_page_count",uid);
		...
		projectionList=sm.queryForList("see_projection_page", u);

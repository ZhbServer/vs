...
public class ToBusListAction extends ActionSupport {
    ...
    public String execute() throws Exception {
		...
		if(sel==0){
			bbs=SqlConnect.getSqlMapInstance().queryForList("sel_bindbus_page",bb);
			total=(Integer)SqlConnect.getSqlMapInstance().queryForObject("sel_bindbus_page_count",uid);
		}else if(sel==1){
	...
	public List<BindBus> getBbs() {
		return bbs;
	}
	public void setBbs(List<BindBus> bbs) {
		this.bbs = bbs;
	}

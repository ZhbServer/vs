...
public class ToPowerListAction extends ActionSupport {
    ...
    public String execute() throws Exception {
		...
		total=(Integer)SqlConnect.getSqlMapInstance().queryForObject("sel_power_page_count");
    	...
    	tempp.setStartid((id - 1) * pagetype);
    	tempp.setPagetype(pagetype);
    	powers=SqlConnect.getSqlMapInstance().queryForList("sel_power_page", tempp);

...
public class AjaxInteractItemSonZTreeRootAction implements Action {
	...
	public String execute() throws Exception {
		...
		ig.setTkey(urtkey);
		List<InteractItemGroup> itemgroup = SqlConnect.getSqlMapInstance().queryForList("sel_interactitemgroup_all", ig);
		if(itemgroup.size() > 0){

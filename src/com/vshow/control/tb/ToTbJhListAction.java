...
public class ToTbJhListAction extends ActionSupport {
	private int id; // 当前页数
	...
	public String execute() throws Exception {
		...
		Tb tb=new Tb();
		tb.setUid(uid);
		total = (Integer) sm.queryForObject("sel_tb_page_count",uid);
		...
		tb.setStartid((id - 1) * pagetype);
		tb.setPagetype(pagetype);
		tbList = sm.queryForList("sel_tb_page", tb);
	...
	public List<Tb> getTbList() {
		return tbList;
	}

	public void setTbList(List<Tb> tbList) {
		this.tbList = tbList;
	}

...
public class SaveShareIItemAction implements Action {
	...
	public String execute() throws Exception {
		...
		String shareStr = "";
			for (int j = 0; j < shareArry.length; j++) {
				...
				int count = (Integer)SqlConnect.getSqlMapInstance().queryForObject("sel_interactitemshare_exist",itemshare);
				if(count == 0){

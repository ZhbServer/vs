...
public class FbDllItemAction implements Action {
			...
			if (itemArray.length > 0) {
				...
				for (int i = 0; i < itemArray.length; i++) {
					...
					if (uocheck == 0||uocheck==3) {
					    ...
					    String logcontent =local.getB00117()+":" + itemnames;
						
					    
					    Log log = LogHandle.insertTheLogSend(LogType.type102, uid, logcontent,1);

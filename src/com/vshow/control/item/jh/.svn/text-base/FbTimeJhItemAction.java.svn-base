...
public class FbTimeJhItemAction implements Action {
			...
			if (itemset.size() > 0) {
				...
				if (uocheck == 0||uocheck==3) {
				      ...
				      **/
					    ...
					    String logcontent =local.getA00653()+"["+local.getA00647()+"]:"+jhName;
						Log log = LogHandle.insertTheLogSend(LogType.type89, uid, logcontent,1);

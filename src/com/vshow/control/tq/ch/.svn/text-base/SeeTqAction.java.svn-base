...
public class SeeTqAction implements Action {
	private List<Tq> tqs;
	private int id; // 当前页数
	...
	public String execute() throws Exception {
		...
		total = (Integer) SqlConnect.getSqlMapInstance().queryForObject("sel_tq_all_page_count");
		...
		tqs = SqlConnect.getSqlMapInstance().queryForList("sel_tq_all_page",temptq);
	...
	public List<Tq> getTqs() {
		return tqs;
	}

	public void setTqs(List<Tq> tqs) {
		this.tqs = tqs;
	}

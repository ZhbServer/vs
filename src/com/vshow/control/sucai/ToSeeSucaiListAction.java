...
public class ToSeeSucaiListAction implements Action {
	...
	public String execute() throws Exception {
		...
		if (sel == 0) {
			...
			if (gssi.getSucaigroupid() == -1) {
				total = (Integer) SqlConnect.getSqlMapInstance()
						.queryForObject("sel_scshare_name_page_count", sucai);
			} else if (gssi.getSucaigroupid() == -2) {
				total = (Integer) SqlConnect.getSqlMapInstance()
						.queryForObject("sel_sc_name_page_count_self", sucai);
			} else {
				if (gssi.getSucaigroupid() == 0) {
					total = (Integer) SqlConnect
							.getSqlMapInstance()
							.queryForObject("sel_sc_name_page_count_all", sucai);
				} else {
					total = (Integer) SqlConnect.getSqlMapInstance()
							.queryForObject("sel_sc_name_page_count_other",
									sucai);
				}
			}
		} else if (sel == 2) {
		...
		if (gssi.getSucaigroupid() == 0 || gssi.getSucaigroupid() == -2) {
			...
			if (gssi.getSucaigroupid() == -1) {
				...
				isSelf = (Integer) SqlConnect.getSqlMapInstance()
						.queryForObject("sel_scgroup_id_uid", gp);
			}
		}
		...
		if (sucai.getType() == 1) {
			if (showtype == 1) {
				return_v = "SUCCESS_BJ_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_BJ_VIEW";
			}
		} else if (sucai.getType() == 4) {
			if (showtype == 1) {
				return_v = "SUCCESS_IMG_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_IMG_VIEW";
			}

		} else if (sucai.getType() == 2) {
			if (showtype == 1) {
				return_v = "SUCCESS_AUDIO_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_AUDIO_VIEW";
			}

		} else if (sucai.getType() == 3) {
			if (showtype == 1) {
				return_v = "SUCCESS_VIDEO_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_VIDEO_VIEW";
			}

		} else if (sucai.getType() == 5) {
			if (showtype == 1) {
				return_v = "SUCCESS_FLASH_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_FLASH_VIEW";
			}

		} else if (sucai.getType() == 6) {
			if (showtype == 1) {
				return_v = "SUCCESS_PPT_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_PPT_VIEW";
			}

		} else if (sucai.getType() == 7) {
			if (showtype == 1) {
				return_v = "SUCCESS_WORD_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_WORD_VIEW";
			}

		} else if (sucai.getType() == 8) {
			if (showtype == 1) {
				return_v = "SUCCESS_EXCEL_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_EXCEL_VIEW";
			}

		} else if (sucai.getType() == 9) {
			if (showtype == 1) {
				return_v = "SUCCESS_PDF_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_PDF_VIEW";
			}

		} else if (sucai.getType() == 10) {
			if (showtype == 1) {
				return_v = "SUCCESS_TXT_LIST";
			} else if (showtype == 2) {
				return_v = "SUCCESS_TXT_VIEW";
			}
